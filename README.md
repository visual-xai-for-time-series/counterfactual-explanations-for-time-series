...
This library implements **31 state-of-the-art counterfactual explanation methods** for time series classification, organized into:
...
- **Hybrid Methods**: SPARCE, Time-CF, TeRCE, MG-CF, TimeX, TimeX++, DiffCF
