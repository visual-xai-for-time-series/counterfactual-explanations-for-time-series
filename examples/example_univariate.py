...
if cf_comte_ts_pl is not None:
    plot_channels(axs[i], cf_comte_ts_pl, f'COMTE-TS Counterfactual — pred: {pred_comte_ts_str}')
else:
    axs[i].set_title('COMTE-TS Counterfactual (none)')
i += 1
...
if cf_lasts_pl is not None:
    plot_channels(axs[i], cf_lasts_pl, f'LASTS Counterfactual — pred: {pred_lasts_str}')
else:
    axs[i].set_title('LASTS Counterfactual (none)')
i += 1

if cf_tscf_pl is not None:
    plot_channels(axs[i], cf_tscf_pl, f'TSCF Counterfactual — pred: {pred_tscf_str}')
else:
...
i += 1
overlay(axs[i], sample_pl, cf_comte_ts_pl, 'COMTE-TS vs Original', pred_comte_ts_str)
i += 1
